...
//!CompilePal::IncludeDirectory("sound/vip_mobster_dev_r1a")
//!CompilePal::IncludeDirectory("sound/mvm/mobster_dev_r1a")
//!CompilePal::IncludeDirectory("sound/vo/mercs_dev_r1a")
